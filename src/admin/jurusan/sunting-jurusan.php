<?php
    ...
    $jurusan = mysqli_query($conn, "SELECT * FROM jurusan WHERE id_jurusan = '$id_jurusan'");
...
<body class="bg-slate-100">
    ...
    <aside class="bg-sky-600 h-screen w-72 rounded-r-2xl shadow-lg">
        ...
        <input type="text" name="kode_jurusan" value="<?= $data_jurusan['kode_jurusan']; ?>"> <br>
        <label for="">Mata Pelajaran</label> <br>
        <input type="text" name="nama_jurusan" value="<?= $data_jurusan['nama_jurusan']; ?>"> <br>   
