...
<body class="bg-slate-100">
    <div class="flex">
        ...
        <main class="h-screen w-screen">
            ...
            <div class="px-8">
                <a href="tambah-jurusan.php">Tambah</a>
                <table class="border-2 border-black">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="sunting-jurusan.php?id=<?= $row['id_jurusan']; ?>">Sunting</a>
                            <a href="hapus-jurusan.php?id=<?= $row['id_jurusan']; ?>" onclick="return confirm('Apakah yakin ingin mengahapus?');">Hapus</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </table>
