...
<body class="bg-slate-100">
    ...
    <aside class="bg-sky-600 h-screen w-72 rounded-r-2xl shadow-lg">
        ...
        <input type="text" name="nama_guru" value="<?= $data_guru['nama_guru']; ?>"> <br>
        <label for="">Jenis Kelamin</label> <br>
        <input type="radio" name="jenis_kelamin" value="L" <?= ($data_guru['jk'] == 'L') ? "checked": ""; ?>>
        <label for="">Laki-laki</label> <br>
        <input type="radio" name="jenis_kelamin" value="P" <?= ($data_guru['jk'] == 'P') ? "checked": ""; ?>>
        <label for="">Perempuan</label> <br>
        <label for="">Alamat</label> <br>
        <textarea name="alamat" cols="30" rows="10" ><?= $data_guru['alamat']; ?></textarea> <br>
