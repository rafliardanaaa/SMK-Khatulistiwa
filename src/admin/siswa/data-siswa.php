...
<body class="bg-slate-100">
    <div class="flex">
        ...
        <main class="h-screen w-screen">
            ...
            <div class="px-8">
                <a href="tambah-siswa.php">Tambah</a>
                <table class="border-2 border-black">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="sunting-siswa.php?nis=<?= $row['nis']; ?>">Sunting</a>
                            <a href="hapus-siswa.php?nis=<?= $row['nis']; ?>" onclick="return confirm('Apakah yakin ingin mengahapus?');">Hapus</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </table>
