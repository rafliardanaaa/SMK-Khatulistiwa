...
<body class="bg-slate-100">
    <div class="flex">
        ...
        <main class="h-screen w-screen">
            ...
            <div class="px-8">
                <a href="tambah-mapel.php">Tambah</a>
                <table class="border-2 border-black">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="sunting-mapel.php?id=<?= $row['id_mapel']; ?>">Sunting</a>
                            <a href="hapus-mapel.php?id=<?= $row['id_mapel']; ?>" onclick="return confirm('Apakah yakin ingin mengahapus?');">Hapus</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </table>
